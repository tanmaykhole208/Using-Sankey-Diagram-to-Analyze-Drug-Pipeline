...
%sankey_nodes(inds=all_cond_int_ph, outds=outds.ptc_sankey2, nodes=%str(spnsr|cond|int|phases), cond=);
...
%sankey2html(in_data=%nrbquote(&sankeydata.), outfl=%sysfunc(pathname(outg,f))/ptc2022.html, width=1900, height=450, flow_num=);
